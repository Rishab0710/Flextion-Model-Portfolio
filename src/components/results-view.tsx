...
const justificationSections: AnimatedSection[] = [
  {
    title: '1. Manager Selection Aligned with Inflection Point Identification',
  ...
  {
    title: '2. Data-Driven Evaluation over Market Timing Noise',
  ...
  {
    title: '3. Robust Scoring and Metric Framework',
  ...
  {
    title: '4. Avoidance of Behavior-Induced Performance Drag',
